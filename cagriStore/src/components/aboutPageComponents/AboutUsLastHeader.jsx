...
function AboutUsLastHeader() {
    return (
        <div className="flex flex-col md:flex-row text-center md:text-start items-center justify-between mb-8 mx-auto  bg-aboutUsLastHeaderColour relative">
            ...
            <div className="relative flex-1 hidden md:block">
                <img src="img/aboutUs/aboutUsLastHeader.jpeg" className="w-full " />
