...
const Breadcrumb = ({ fromProductDetailPage, fromTeamHeaderComponents, backgroundColor, showOnMobile }) => {
    ...
    return (
        <div className={`flex flex-col items-center p-4 ${backgroundColor ? backgroundColor : 'bg-mainBackgroundWhite'} rounded-md w-full md:flex-row md:justify-between ${showOnMobile ? '' : 'hidden md:flex'}`}>
            <div className="w-full flex flex-col items-center md:flex-row md:justify-between md:w-[92%] mx-auto">
                {fromTeamHeaderComponents ? null : (
