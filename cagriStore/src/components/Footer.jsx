...
//     return (
//         <>
//             <div className="bg-footerLightGray container">
...
//                 </div>
//             </div>
//             <div className="w-full items-center justify-center pt-6 pb-6 text-center bg-footerLightGray">
//                 <h1 className='text-textColorLightGray font-semibold'>Made With Love By</h1>
//                 <h1 className='text-textColorLightGray font-semibold'>Finland All Right Reserved</h1>
//             </div>
//         </>
//     );
// }
